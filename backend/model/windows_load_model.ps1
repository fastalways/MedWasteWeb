...
$client.DownloadFile("https://asset.coecore.com/model-ai/medical-waste/4G-EfficientNetB5-epoch2000.pb.zip",($CUR_DIR.Path+"\4G-EfficientNetB5-epoch2000.pb.zip"))
echo 'Loading Model from https://asset.coecore.com/model-ai/medical-waste/41CLASSES-EfficientNetB5-epoch2000.pb.zip'
$client.DownloadFile("https://asset.coecore.com/model-ai/medical-waste/41CLASSES-EfficientNetB5-epoch2000.pb.zip",($CUR_DIR.Path+"\41CLASSES-EfficientNetB5-epoch2000.pb.zip"))
echo 'Loading Model from https://asset.coecore.com/model-ai/medical-waste/10FreqCLASSES-EfficientNetB5-epoch1000.pb.zip'
$client.DownloadFile("https://asset.coecore.com/model-ai/medical-waste/10FreqCLASSES-EfficientNetB5-epoch1000.pb.zip",($CUR_DIR.Path+"\10FreqCLASSES-EfficientNetB5-epoch1000.pb.zip"))
echo 'Loading Model from https://asset.coecore.com/model-ai/medical-waste/yolo_v4_41CLASSES.zip'
$client.DownloadFile("https://asset.coecore.com/model-ai/medical-waste/yolo_v4_41CLASSES.zip",($CUR_DIR.Path+"\yolo_v4_41CLASSES.zip"))
echo 'Loading Model from https://asset.coecore.com/model-ai/medical-waste/yolo_v5_41CLASSES.zip'
$client.DownloadFile("https://asset.coecore.com/model-ai/medical-waste/yolo_v5_41CLASSES.zip",($CUR_DIR.Path+"\yolo_v5_41CLASSES.zip"))
